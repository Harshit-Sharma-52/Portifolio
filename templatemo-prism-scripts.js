...
const portfolioData = [
    {
        id: 1,
        title: 'Indian EcomX',
        description: 'A responsive e-commerce website with product browsing, shopping cart, and an admin dashboard. Demo Admin: admin / admin123',
        image: 'images/ecommerce.png',
        tech: ['React.js', 'JavaScript', 'CSS3'],
        live: 'https://ecomm-seller.netlify.app/',
        github: 'https://github.com/Harshit-Sharma-52/Inadian-EcomX'
    },

    {
        id: 2,
        title: 'Luxoria Estates',
        description: 'A modern real estate platform for browsing, searching, and managing properties with a responsive interface and admin dashboard. Demo Admin: luxoria.india / luxoria@123',
        image: 'images/luxoria.png',
        tech: ['React.js', 'JavaScript', 'Tailwind CSS'],
        live: 'https://lusxury-estates.netlify.app/',
        github: 'https://github.com/Harshit-Sharma-52/Luxoria-Estates'
    },

    {
        id: 3,
        title: 'PromptForge AI',
        description: 'A simple AI prompt generator that helps users create and organize prompts for ChatGPT, Gemini, Claude, Midjourney, and other AI tools.',
        image: 'images/prompt.png',
        tech: ['React.js', 'JavaScript', 'Tailwind CSS'],
        live: 'https://prompt-generator-virid-ten.vercel.app/',
        github: 'https://github.com/Harshit-Sharma-52/Pompt--Generator'
    },

    {
        id: 4,
        title: 'StudyFlow AI',
        description: 'An AI-powered learning platform that helps students study smarter with AI assistance, smart notes, and progress tracking.',
        image: 'images/studyflow.png',
        tech: ['React.js', 'JavaScript', 'AI'],
        live: 'https://study-floww.netlify.app/',
        github: 'https://github.com/Harshit-Sharma-52/Study-Flow'
    }
];

// Skills data
const skillsData = [
    { name: 'Python', icon: '🐍', level: 85, category: 'programming' },
    ...
    item.innerHTML = `
        <div class="card">
            ...
            <div class="card-actions">
                <a href="${data.live}" target="_blank" class="card-cta">View</a>
                <a href="${data.github}" target="_blank" class="card-cta cta-outline">GitHub</a>
            </div>
        </div>
    `;
